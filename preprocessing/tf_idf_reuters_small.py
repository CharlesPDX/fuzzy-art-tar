...
def get_tf_idf_reuters_small_corpus():
    ...
    return reuters_small_vectorized_corpus, document_corpus_index_map, {document_id: document["topics"] for document_id, document in documents_with_topics_and_bodies.items()}
